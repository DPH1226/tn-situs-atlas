...
<nav class="views"><a href="../">Counties</a><a class="on" href="./">Cities</a><a href="../flows/">Revenue flows</a></nav></div></header>
<div class="wrap">
...
<div class="explain"><h3>How to read this</h3><ul><li><b>Rooftops / Businesses</b> — inside the city's own Department of Revenue situs polygon. This is the city's tax base as the State draws it.</li><li><b>Cross-county postal</b> and <b>Boundary risk</b> — businesses inside the polygon flagged as on the county page.</li><li><b>Postal exposure</b> — a business <b>outside</b> the polygon carrying this city's mailing address, where a mailing-address registration would have coded it to the city.</li><li><b>File says elsewhere</b> — the city's counter-finding: rooftops inside the polygon that the State's own address-range file codes to another jurisdiction, usually the county's unincorporated code. Corrected, those move money <b>to</b> the city.</li><li><b>File claims city</b> — the reverse: rooftops outside the polygon that the address file codes to the city.</li><li><b>Other layers say city</b> — the strongest counter-finding: rooftops the Department places outside the city while both the 911 authority and the Comptroller's certified limits place them inside it.</li><li><b>None of these is a finding</b> until the city's situs report is compared. The <b>Revenue flows</b> view sizes them in dollars.</li></ul></div>
